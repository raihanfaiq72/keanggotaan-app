...
<div class="right_col" role="main">
    ...
    <div class="row" style="display: inline-block;">
        <div class="tile_count">
            ...
            @foreach($userJabHitung as $p => $count)
            <div class="col-md-2 col-sm-4  tile_stats_count">
                <span class="count_top"><i class="fa fa-user"></i> Total Jab {{$p}}</span>
            ...
            <div class="col-md-2 col-sm-4  tile_stats_count">
                <span class="count_top"><i class="fa fa-user"></i> Total Jab Struk</span>
                            ...
                            <li>
                                <div class="block">
                                    <div class="block_content">
                                        ...
                                        <div class="byline">
                                            <span>12 jam yang lalu</span> by <a>Admin</a>
                                        </div>
                                        <p class="excerpt">{{$data}}</a>
                                        </p>
                                    </div>
                                </div>
                            </li>
