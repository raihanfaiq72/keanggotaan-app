            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div class="table-responsive">
                        <a href="{{url('sekretaris/anggota')}}/create"><button>Tambah Anggota</button></a>
                        <table class="table table-striped jambo_table bulk_action">
                            ...
                            <tbody>
                                ...
                                <tr class="odd pointer">
                                    ...
                                    <td class=" last"><a href="{{url('/sekretaris/anggota/'.$p->id,[])}}">View</a>
                                    <td class=" last"><a href="{{url('/sekretaris/anggota/'.$p->id,[])}}/edit">Edit</a>
                                    <td class="last">
